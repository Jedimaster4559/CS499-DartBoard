...
class Ui_StartGameConfiguration(object):
    def setupUi(self, StartGameConfiguration):
        ...
        self.player_one_line_edit = QLineEdit(self.centralwidget)
        self.player_one_line_edit.setObjectName(u"player_one_line_edit")

        self.gridLayout.addWidget(self.player_one_line_edit, 1, 0, 1, 7)
        ...
        self.player_two_line_edit = QLineEdit(self.centralwidget)
        self.player_two_line_edit.setObjectName(u"player_two_line_edit")

        self.gridLayout.addWidget(self.player_two_line_edit, 3, 0, 1, 7)
