...
class Ui_Scoreboard(object):
    def setupUi(self, Scoreboard):
        ...
        self.Player1DartsTable.setMinimumSize(QSize(200, 0))
        self.Player1DartsTable.setMaximumSize(QSize(400, 10000))
        ...
        self.Player1DartsTable.horizontalHeader().setDefaultSectionSize(99)
        ...
        self.gridLayout.addWidget(self.Player1DartsTable, 2, 0, 1, 1)
        ...
        self.player_2_score.setFont(font3)
        ...
        self.Player2DartsTable.setMinimumSize(QSize(400, 0))
        self.Player2DartsTable.setMaximumSize(QSize(400, 16777215))
        ...
        self.Player2DartsTable.horizontalHeader().setDefaultSectionSize(99)
        ...
        self.gridLayout.addWidget(self.Player2DartsTable, 2, 4, 1, 1)
