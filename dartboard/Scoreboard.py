...
class Ui_Scoreboard(object):
    def setupUi(self, Scoreboard):
        ...
        self.label_3.setStyleSheet(u"background-color: rgb(223, 223, 223);")
        ...
        self.label_4.setStyleSheet(u"background-color: rgb(223, 223, 223);")
        ...
        self.label_2.setStyleSheet(u"background-color: rgb(223, 223, 223);")
